...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { course: @grade.course, grade: @grade.grade, user_id: @grade.user_id } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { course: @grade.course, grade: @grade.grade, user_id: @grade.user_id } }
