...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { content: @update.content, user_id: @update.user_id } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { content: @update.content, user_id: @update.user_id } }
